...
from mlagents.trainers.mltorch.layers import LinearEncoder, Initialization
import numpy as np
...
from mlagents.trainers.mltorch.attention import EntityEmbedding, ResidualSelfAttention
